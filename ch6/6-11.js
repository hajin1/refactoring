export function calculateDiscount(product, quantity) {
	return Math.max(quantity - product.discountThreshold, 0) * product.basePrice * product.discountRate;
}

export function calculateBasePrice(product, quantity) {
	return product.basePrice * quantity;
}

export function calculateShippingCost(basePrice, quantity, shippingMethod) {
